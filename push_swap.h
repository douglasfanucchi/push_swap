...
/*   Updated: 2026/06/30 14:41:01 by dode-lim         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_bool			ft_exec_operation(t_state *state,
...
int				ft_state_get_operation_count(const t_state *state,
					t_operations op);
...
void			ft_quicksort(t_arr arr, size_t bytes,
					t_bool (*lt)(void *, int, int),
